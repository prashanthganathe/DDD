...
{
    public class DomainProductService : DomainServiceBase<Product>, IDomainProductService
    {
        private readonly IProductRepository _productRepository;

        public DomainProductService(IProductRepository productRepository, IUnitOfWork uow) :base(uow)
        {
