...
namespace CZ_Application
{
    ...
    {
        private readonly IDomainServiceBase<TEntity> _serviceBase;
           
        public AppServiceBase(IDomainServiceBase<TEntity> serviceBase)
        {
        ...
        {
            return _serviceBase.GetAll(predicate,out count);
        }
